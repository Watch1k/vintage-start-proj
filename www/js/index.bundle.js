...
var toggleClass = exports.toggleClass = function toggleClass(clickHandler, element) {
  clickHandler.on('click tap', function () {
    return element.toggleClass(css.active);
  });
};
...
Main.test = function () {
  console.log('isTouch: ', _helpers.Resp.isTouch);
  console.log('isDesk: ', _helpers.Resp.isDesk);
  console.log('isTablet: ', _helpers.Resp.isTablet);
  console.log('isMobile: ', _helpers.Resp.isMobile);
};
